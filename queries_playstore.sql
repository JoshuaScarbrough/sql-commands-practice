...
SELECT * FROM analytics WHERE rating >= 4 ORDER BY reviews DESC LIMIT 1;
...
SELECT app_name, price, rating FROM analytics WHERE rating < 3 GROUP BY price DESC LIMIT 1;
